Feature: Filling shipping details with reusable steps
  ...
  Scenario: Fill shipping details for different entities
    ...
    When  I fill the details for "Consignee" with name "XYZ Corp", address "789 Road, LA", and partner "DHL"
    And   I fill the details for "Forwarder" with name "LMN Shipping", address "456 Blvd, SF", and partner "UPS"
  ...
  Scenario: I fill the details for "<Entity>" with name "<Name>", address "<Address>", and partner "<Partner>"
    ...
    When  I enter "<Address>" in "<Entity> Address"
